...
```sh
curl -LO https://github.com/jpillora/chisel/releases/download/v1.8.1/chisel_1.8.1_linux_amd64.gz
...
```sh
curl -LO https://github.com/jpillora/chisel/releases/download/v1.8.1/chisel_1.8.1_windows_amd64.gz
gzip -d chisel_1.8.1_windows_amd64.gz
mv chisel_1.8.1_windows_amd64 /var/www/html/chisel.exe
```
