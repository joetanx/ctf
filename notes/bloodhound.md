...
```sh
apt update && apt -y install bloodhound bloodhound-ce-python
```
...
Select the zip file generated by `bloodhound-ce-python` and `Upload`:

![](https://github.com/user-attachments/assets/dec00541-b8ba-4fef-bedc-364c00030122)

![](https://github.com/user-attachments/assets/ebe42678-6094-4c52-b13d-9289ded9fda2)
...
![](https://github.com/user-attachments/assets/cc43db4b-d870-4899-a7b7-86903c734295)

![](https://github.com/user-attachments/assets/4e4b31bc-d9ca-43e6-a7dd-12c7378646b3)
...
### 3.1. All Domain Admins

![](https://github.com/user-attachments/assets/e69bebc5-378a-489a-a8fd-e96a137045fa)

### 3.2. List all Kerberoastable Accounts

![](https://github.com/user-attachments/assets/1f4ed637-7c68-4daf-b00e-1b5f82ba7593)

### 3.3. Find AS-REP Roastable Users (DontReqPreAuth)

![](https://github.com/user-attachments/assets/e030c69e-3e5b-4e9b-8797-6d3c2b3ee865)

### 3.4. Shortest Paths to Domain Admins

![](https://github.com/user-attachments/assets/cc2bf3a8-a2c4-460f-b78b-c3cdf6999109)

### 3.5. Principals with DCSync Rights
